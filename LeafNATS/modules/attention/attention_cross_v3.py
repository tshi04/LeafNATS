...
class CrossAttention(torch.nn.Module):
    ...
    def __init__(
        ...
        self.projA = torch.nn.Linear(inputA_size, hidden_size)
        self.projB = torch.nn.Linear(inputB_size, hidden_size)
    ...
    def forward(self, inputA, inputB, maskA=None, maskB=None):
        ...
        projA = torch.relu(self.projA(inputA))
        projB = torch.relu(self.projB(inputB))
