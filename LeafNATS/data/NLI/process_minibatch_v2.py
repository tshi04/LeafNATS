...
{'premise': content, 'hypothesis': content, 'gold_label': 1, 'premise_pos': content, 'hypothesis_pos': content}
'''
def process_minibatch(input_, vocab2id, vocab2id_char, vocab2id_pos, premise_max_lens, hypothesis_max_lens):
