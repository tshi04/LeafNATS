...
'''
parser.add_argument('--task', default='train', help='train | validate | rouge | beam | app')
...
parser.add_argument('--sum_seq_lens', type=int, default=50, help='length of target documents.')
...
if args.task == 'train' or args.task == 'validate' or args.task == 'beam':
    from LeafNATS.playground.summary_headline_multitask import modelMultiTask
...
if args.task == "app":
    from LeafNATS.playground.summary_headline_multitask_app import modelMultiTaskApp
