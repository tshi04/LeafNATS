...
from LeafNATS.playground.pointer_generator_network_trans import modelNatsTransfer
...
parser.add_argument('--base_model_dir', default='../../sum_data/base_models', help='file store training vocabulary.')
