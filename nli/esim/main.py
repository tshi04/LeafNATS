...
parser.add_argument('--data_dir', default='../snli_data',
                    help='directory that store the data.')
parser.add_argument('--file_train', default='train.json',
                    help='file store training documents.')
parser.add_argument('--file_val', default='dev.json',
                    help='validation (dev) data')
...
parser.add_argument('--is_lower', type=str2bool, default=False,
...
parser.add_argument('--emb_source', default='pretrain',
                    help='scrach | pretrain')
parser.add_argument('--emb_dim', type=int, default=300,
                    help='source embedding dimension')
parser.add_argument('--file_vocab', default='vocab',
                    help='file store vocabulary.')
parser.add_argument('--file_vocab_pos', default='vocab_pos',
                    help='file store vocabulary.')
parser.add_argument('--file_vocab_char', default='vocab_char',
                    help='file store vocabulary.')
# optimization
...
parser.add_argument('--premise_max_lens', type=int,
                    default=50, help='length of premise.')
parser.add_argument('--hypothesis_max_lens', type=int,
                    default=50, help='length of hypothesis.')
# dropout
