...
parser.add_argument('--data_dir', default='../cqa_data/cqa_data_annotated',
...
parser.add_argument('--val_num_batch', type=int,
                    default=100, help='how many batches')
parser.add_argument('--nbestmodel', type=int, default=5,
...
parser.add_argument('--src_seq_len', type=int, default=400,
                    help='length of source documents.')
parser.add_argument('--trg_seq_len', type=int, default=100,
...
parser.add_argument('--file_output', default='output.json',
